...
1. [Download v1.2.4](https://github.com/thexmanxyz/network-share-reconnecter/releases/download/v1.2.4/nsr.v1.2.4.zip) of the Network Share Reconnecter Package.
2. Extract the files.
