...
1. [Download v1.2.3](https://github.com/thexmanxyz/network-share-reconnecter/releases/download/v1.2.3/nsr.v1.2.3.zip) of the Network Share Reconnecter Package.
2. Extract the files.
