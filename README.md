...
1. [Download v1.1.1](https://github.com/thexmanxyz/network-share-reconnecter/releases/download/v1.1.1/nsr.v1.1.1.zip) of the Network Share Reconnecter Package
2. Extract the files
